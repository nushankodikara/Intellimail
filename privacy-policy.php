...
<body>
    ...
    <section
        class="bg-center bg-no-repeat bg-[url('https://unsplash.com/photos/_3KdlCgHAn0/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8Mnx8QUl8ZW58MHx8fHwxNjkxNjA2MDM3fDA&force=true&w=1920')] bg-gray-700 bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                Protecting Your Privacy</h2>
                <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">We take your privacy
                    seriously. This page outlines how we collect, use, share, and protect your personal information when
                    you
                    use our AI email assistant and web app. We only collect the minimum data needed to provide our
                    services
                    and give you control over your information. Read our full privacy policy to learn more about your
                    rights
                    and how we safeguard your data.
                </p>
        </div>
    </section>
    ...
    <section class="p-4 flex flex-col justify-center items-center">
        <div class=" max-w-3xl text-justify">
            <h1 class="text-3xl pb-4">Privacy Policy for IntelliMail</h1>

            <p>At Intellimail.site, accessible from https://www.intellimail.site, one of our main priorities is the
                privacy of our visitors. This Privacy Policy document contains types of information that is collected
                and recorded by Intellimail.site and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in Intellimail.site. This policy is not
                applicable to any information collected offline or via channels other than this website.</p>

            <h2 class="text-xl py-4">Consent</h2>

            <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

            <h2 class="text-xl py-4">Information we collect</h2>
            ...
            <h2 class="text-xl py-4">How we use your information</h2>
            ...
            <h2 class="text-xl py-4">Log Files</h2>

            <p>Intellimail.site follows a standard procedure of using log files. These files log visitors when they
            ...
            <h2 class="text-xl py-4">Cookies and Web Beacons</h2>

            <p>Like any other website, Intellimail.site uses "cookies". These cookies are used to store information
            ...
            <h2 class="text-xl py-4">Advertising Partners Privacy Policies</h2>
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on Intellimail.site, which are sent
            ...
            <p>Note that Intellimail.site has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2 class="text-xl py-4">Third Party Privacy Policies</h2>

            <p>Intellimail.site's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            ...
            <h2 class="text-xl py-4">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            ...
            <h2 class="text-xl py-4">GDPR Data Protection Rights</h2>
            ...
            <h2 class="text-xl py-4">Children's Information</h2>
            ...
            <p>Intellimail.site does not knowingly collect any Personal Identifiable Information from children under the
            ...
            <h2 class="text-xl py-4">Changes to This Privacy Policy</h2>
            ...
            <h2 class="text-xl py-4">Contact Us</h2>
