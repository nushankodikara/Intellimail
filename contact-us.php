            ...
            <div class="container flex flex-col flex-1 px-6 py-12 mx-auto">
                <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
                    <div class="text-white lg:w-1/2 lg:mx-6">
                        <h1 class="text-2xl font-semibold capitalize lg:text-3xl">Contact Us Today</h1>

                        <p class="max-w-xl mt-6">
                            We value your feedback and inquiries. Whether you have questions about our products,
                            services, or just want to say hello, we're here to assist you. Feel free to reach out and
                        ...
                        <div
                            ...
                            if (isset($_GET['error'])) {
                                if ($_GET['error'] == "emptyfields") {
                                    echo '<p class="text-red-500 text-xs mt-2">Fill in all fields!</p>';
                                } else if ($_GET['error'] == "invalidmail") {
                                    echo '<p class="text-red-500 text-xs mt-2">Invalid email!</p>';
                                } else if ($_GET['error'] == "sqlerror") {
                                    echo '<p class="text-red-500 text-xs mt-2">Something Went Wrong. Please Try Again.</p>';
                                } else if ($_GET['error'] == "success") {
                                    echo '<p class="text-green-500 text-xs mt-2">Message sent!</p>';
                                }
                            }
                            ?>

                            <form class="mt-6" action="/functions/contact.php" method="post">
                                <div class="flex-1">
